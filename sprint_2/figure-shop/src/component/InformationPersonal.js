...
export const InformationPersonal = () => {
    ...
    return (
        <>
            <div className="container" style={{marginTop: 114}}>
                            ...
                            <div className="profile-sidebar">
                                ...
                                <div className="profile-usermenu">
                                    <ul className="nav">
                                        ...
                                        <li>
                                            <Link to={`/user/history`} style={{color: "#212529" , fontSize:16 , fontFamily: "Netflix Sans, Helvetica Neue, Segoe UI, Roboto, Ubuntu, sans-serif" , fontWeight: 400}}>
                                ...
                                <div className="content">
                                    <div className="container bg-white pt-5">
                                        <div className="row px-3 pb-2">
                                            <h1 className="text-center info"  style={{marginBottom: 75}}>Thông tin cá nhân</h1>
